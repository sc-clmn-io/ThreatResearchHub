...
export default function SequentialWorkflowPage() {
  ...
  const handleWorkflowComplete = (results: any) => {
    ...
    toast({
      ...
      description: "Your XSIAM enablement workflow has been completed successfully."
    });
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">XSIAM Enablement Workflow</h1>
          <p className="text-muted-foreground mt-2">
            Complete end-to-end workflow from threat intelligence to deployed XSIAM content with clear step-by-step instructions
          </p>
        </div>
