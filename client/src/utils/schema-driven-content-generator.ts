  ...
  static initialize() {
    ...
    this.datasetSchemas.set('windows_defender', {
      ...
      fields: [
        ...
        { name: 'network_remote_ip', type: 'string', description: 'Remote IP address', sample_values: ['192.168.100.100', '10.0.0.5'], xql_accessible: true }
      ]
    });
    ...
    this.datasetSchemas.set('aws_cloudtrail', {
      ...
      fields: [
        ...
        { name: 'sourceIPAddress', type: 'string', description: 'Source IP address', sample_values: ['203.0.113.12', '192.168.100.100'], xql_accessible: true },
    ...
    this.datasetSchemas.set('crowdstrike', {
      ...
      fields: [
        ...
        { name: 'RemoteAddressIP4', type: 'string', description: 'Remote IPv4 address', sample_values: ['203.0.113.12', '192.168.100.100'], xql_accessible: true },
    ...
    this.datasetSchemas.set('kubernetes', {
      ...
      fields: [
        ...
        { name: 'sourceIPs', type: 'array', description: 'Source IP addresses', sample_values: ['192.168.100.100', '10.0.0.5'], xql_accessible: true },
