...
// Based on CVE-2025-1974 (IngressNightmare) shown in threat feeds
...
export const demoUseCases = [
  {
    ...
    category: 'cloud',
    severity: 'critical',
    cves: ['CVE-2025-1974', 'CVE-2025-3956', 'CVE-2025-0995'],
...
| sort desc _time`,
    ...
    sources: [
      { vendor: 'CISA', url: 'https://cisa.gov/advisory/cve-2025-1974', title: 'CVE-2025-1974: IngressNightmare Kubernetes Vulnerability' },
...
export const demoTrainingPaths = [
  {
    ...
    description: 'Complete incident response workflow for CVE-2025-1974 exploitation attempts',
    category: 'cloud',
    severity: 'critical',
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Run SOAR playbook for CVE-2025-1974 remediation',
        timeEstimate: 45,
        completed: false,
        requirements: [
