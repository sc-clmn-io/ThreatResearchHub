    ...
    try {
      ...
      if (isDuoGuoRaw) {
          ...
          vendorFields = [
            ...
            { name: 'source_ip', type: 'string', description: 'Source IP address', sample_values: ['192.168.1.100', '10.0.0.45'], xql_accessible: true },
            ...
            { name: 'auth_device_ip', type: 'string', description: 'Authentication device IP', sample_values: ['192.168.1.101'], xql_accessible: true },
        ...
        if (isAWSCloudTrail) {
          vendorFields = [
            ...
            { name: 'sourceIPAddress', type: 'string', description: 'Source IP address', sample_values: ['192.168.1.100'], xql_accessible: true },
          ...
          vendorFields = [
            ...
            { name: 'src', type: 'string', description: 'Source IP address', sample_values: ['192.168.1.100'], xql_accessible: true },
