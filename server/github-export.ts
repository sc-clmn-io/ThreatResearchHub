...
export async function exportToGitHub(config: GitHubExportConfig): Promise<ExportResult> {
  ...
  try {
    ...
    process.env.GIT_AUTHOR_EMAIL = 'threatresearchhub@replit.com';
    process.env.GIT_COMMITTER_NAME = 'ThreatResearchHub';
    process.env.GIT_COMMITTER_EMAIL = 'threatresearchhub@replit.com';
    ...
    try {
      ...
      await execAsync('git config user.email "threatresearchhub@replit.com"');
